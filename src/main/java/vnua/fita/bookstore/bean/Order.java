...
public class Order implements Comparable<Order> {
	...
	private String failureImagePath; // đường dẫn ảnh chụp màn hình chuyển tiền hoặc phiếu
										// ATM
	...
	public void setOrderStatus(byte orderStatus) {
		...
		switch(orderStatus) {
			...
			case Constant.REJECT_ORDER_STATUS:
				...
				break;
			case Constant.FAILURE_ORDER_STATUS:
				this.orderStatusDescription = "Hàng bị hỏng";
				break;
